        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full md:w-1/2 lg:w-1/4 px-4 mb-4">
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              <div class="p-4 bg-slate-100">
                <h3 class="text-xl font-extrabold mb-2">Physical</h3>
          ...
          <div class="w-full md:w-1/2 lg:w-1/4 px-4 mb-4">
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              />
              <div class="p-4 bg-slate-100">
                <h3 class="text-xl font-extrabold mb-2">Web/Tech</h3>
                <p class="text-gray-600 font-medium">
          ...
          <div class="w-full md:w-1/2 lg:w-1/4 px-4 mb-4">
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              />
              <div class="p-4 bg-slate-100">
                <h3 class="text-xl font-extrabold mb-2">Social Media</h3>
                <p class="text-gray-600 font-medium">
          ...
          <div class="w-full md:w-1/2 lg:w-1/4 px-4 mb-4">
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
              ...
              />
              <div class="p-4 bg-slate-100">
                <h3 class="text-xl font-extrabold mb-2">3D Printing / Laser</h3>
                <p class="text-gray-600 font-medium">
